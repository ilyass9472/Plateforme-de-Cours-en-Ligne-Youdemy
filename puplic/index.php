    ...
    <div class="flex">
        <div class="w-64 h-screen bg-indigo-600 text-white">
            <div class="p-4">
                ...
                <ul class="mt-6">
                    <li>
                        <a href="index.php" class="block py-2 px-4 hover:bg-indigo-700">Dashboard</a>
                    </li>
                    <li>
                        <a href="courses.php" class="block py-2 px-4 hover:bg-indigo-700">Manage Courses</a>
                    </li>
                    <li>
                        <a href="createCourses.php" class="block py-2 px-4 hover:bg-indigo-700">Create Courses</a>
                    </li>
                    <li>
                        <a href="users.php" class="block py-2 px-4 hover:bg-indigo-700">Manage Users</a>
                    </li>
                    <li>
                        <a href="logout.php" class="block py-2 px-4 hover:bg-indigo-700">Logout</a>
                    </li>
                </ul>
            </div>
        </div>
